    ...
    return (
      <>
        ...
        <header className="relative w-full pt-6 pb-4 md:pt-10 md:pb-6 px-4 md:px-8 flex flex-col items-center justify-center z-20">
          <div className="max-w-6xl w-full bg-white/60 backdrop-blur-3xl rounded-[32px] md:rounded-[48px] p-6 md:p-10 border border-white/80 shadow-2xl shadow-blue-900/5">
